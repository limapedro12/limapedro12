...
- Python:
     ...
     - **Chess Image Recognition**: This consists in a system to recognize pieces of chess, their types, colour and positions. [Link to repository](https://github.com/limapedro12/VCOM_Chess)
- Other:
